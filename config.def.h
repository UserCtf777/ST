...
static char *font2[] = {
	...
	//"Symbola_hint:pixelsize=22:antialias=true:autohint=true", 
...
float grad_alpha = 0.74; //alpha value that'll change
float stat_alpha = 0.66; //constant alpha value that'll get added to grad_alpha
